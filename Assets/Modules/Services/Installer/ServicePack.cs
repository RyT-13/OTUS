...
{
    [CreateAssetMenu(fileName = "Service Pack", menuName = "Modules/New Service Pack", order = 0)]
    public class ServicePack : ScriptableObject
    {
#if UNITY_EDITOR
        [SerializeField] private bool editorMode;

        [SerializeField] private MonoScript[] releaseScripts;

        [SerializeField] private MonoScript[] editorScripts;
#endif
        [SerializeField] private string[] releaseClassNames;
